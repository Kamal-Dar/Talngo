...
class ChallengeVideoTab extends StatelessWidget {
  ...
  ChallengeVideoTab(this.videos, this.images, this.isFollowing, {this.variable});

  @override
  Widget build(BuildContext context) {
    return ChallengeVideoTabBody(videos, images, isFollowing, variable);
  }
}

class ChallengeVideoTabBody extends StatefulWidget {
  final List<String> videos;
  final List<String> images;
  final bool isFollowing;
  final int? variable;
 
  ChallengeVideoTabBody(this.videos, this.images, this.isFollowing, this.variable);

  @override
  _ChallengeVideoTabBodyState createState() => _ChallengeVideoTabBodyState();
}

class _ChallengeVideoTabBodyState extends State<ChallengeVideoTabBody> {
