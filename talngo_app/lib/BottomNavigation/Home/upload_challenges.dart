...
class UploadChallengePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return UploadChallengeBody();
  }
}

class UploadChallengeBody extends StatefulWidget {
  @override
  _MyProfileBodyState createState() => _MyProfileBodyState();
}

class _MyProfileBodyState extends State<UploadChallengeBody> {
  final key = UniqueKey();
...
//final List<String> categoryList = ['Eating', 'Singing', 'Dancing'];
 ...
 void getCredentials() async {
  ...
  // uploadVideo(File videoFile, BuildContext context1) async {
  ...
  //   // string to uri
  //   var uri = Uri.parse("https://talngo.com/api/random-challeng");
  ...
  //   request.fields['heading'] = "Kuch bhi add kr do";
  //   request.fields['category'] = "Kuch bhi add kr do";
  //   request.fields['description'] = "Kuch bhi add kr do";
